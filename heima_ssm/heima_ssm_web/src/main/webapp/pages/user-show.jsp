...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
							...
							<table id="collapse-table"
								...
								<tbody>
									<c:forEach items="${user.roleList}" var="role" varStatus="vs">
										...
										<c:forEach items="${role.permissionList}" var="permission" varStatus="vs2">
											<tr data-tt-id="${vs2.count}-${vs2.count}" data-tt-parent-id="${vs.count}">
				...
				<%--<div class="box-footer">
						...
						<div class="form-group form-inline">
							...
							<select class="form-control" id="changePageSize" onchange="changePageSize()">
								<c:forEach begin="1" end="10" var="index">
									&lt;%&ndash;                                    如果是当前设置的pageSize 选中显示&ndash;%&gt;
					...
					&lt;%&ndash;                   分页页面底部导航栏 &ndash;%&gt;
					<div class="box-tools pull-right">
						<ul class="pagination">
							&lt;%&ndash;                            跳转到选择的页面&ndash;%&gt;
							...
							<c:forEach begin="${pageInfo.pageNum-pageInfo.navigatePages < 1 ? 1 : pageInfo.pageNum-pageInfo.navigatePages}" end="${pageInfo.pageNum+pageInfo.navigatePages > pageInfo.pages? pageInfo.pages: pageInfo.pageNum+pageInfo.navigatePages}" var="index">
								&lt;%&ndash;                                    如果是当前设置的pageNum 选中显示&ndash;%&gt;
							...
							&lt;%&ndash;                            上一页 如果没有上一页 禁用 并且不给链接&ndash;%&gt;
							...
							&lt;%&ndash;                            中间页&ndash;%&gt;
							&lt;%&ndash;                                    循环遍历pageInfo中的导航页数
                                                                       当前页 active 并且 没有链接&ndash;%&gt;
							...
							&lt;%&ndash;                            下一页 如果没有下一页 禁用 并且不给链接&ndash;%&gt;
							...
							&lt;%&ndash;                            尾页 如果已是尾页,禁用并且没有链接&ndash;%&gt;
							<c:if test="${pageInfo.isLastPage}">
	...
	<script
		src="${pageContext.servletContext.contextPath}/plugins/datepicker/locales/bootstrap-datepicker.zh-CN.js"></script>
	<script
		src="${pageContext.servletContext.contextPath}/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
	...
	<script
		src="${pageContext.servletContext.contextPath}/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.zh-CN.js"></script>
	<script src="${pageContext.servletContext.contextPath}/plugins/bootstrap-markdown/js/bootstrap-markdown.js"></script>
	<script
		src="${pageContext.servletContext.contextPath}/plugins/bootstrap-markdown/locale/bootstrap-markdown.zh.js"></script>
