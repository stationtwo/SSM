...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<table id="dataList"
							...
							<tbody>
								<c:forEach items="${pageInfo.list}" var="syslog" varStatus="count">
									<tr>
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<c:if test="${!pageInfo.isFirstPage}">
								<li>
									<a href="${pageContext.servletContext.contextPath}/sysLog/findAll.do?page=1&pageSize=${pageInfo.pageSize}">首页</a>
								</li>
							</c:if>
							...
							<c:if test="${pageInfo.hasPreviousPage}">
								<li>
									<a href="${pageContext.servletContext.contextPath}/sysLog/findAll.do?page=${pageInfo.prePage}&pageSize=${pageInfo.pageSize}">上一页</a>
								</li>
							</c:if>
							<c:if test="${pageInfo.isFirstPage}">
							...
							<c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
								<c:if test="${pageInfo.pageNum != page_num}">
									<li>
										<a href="${pageContext.servletContext.contextPath}/sysLog/findAll.do?page=${page_num}&pageSize=${pageInfo.pageSize}">${page_num}</a>
									</li>
								</c:if>
								<c:if test="${pageInfo.pageNum == page_num}">
							...
							<c:if test="${pageInfo.hasNextPage}">
								<li>
									<a href="${pageContext.servletContext.contextPath}/sysLog/findAll.do?page=${pageInfo.nextPage}&pageSize=${pageInfo.pageSize}">下一页</a>
								</li>
							</c:if>
							...
							<c:if test="${!pageInfo.isLastPage}">
								<li>
									<a href="${pageContext.servletContext.contextPath}/sysLog/findAll.do?page=${pageInfo.pages}&pageSize=${pageInfo.pageSize}">尾页</a>
								</li>
							</c:if>
	...
	<script>
		...
		function changePageNum() {
			...
			//向服务器发送请求，改变每页显示条数
			location.href = "${pageContext.request.contextPath}/sysLog/findAll.do?page="+pageNum+"&pageSize=${pageInfo.pageSize}";
		}
