...
-- Created by ½ÜÍþÁ¦ on 2019/6/25, 15:07:07 --
-------------------------------------------
...
alter table SSM.ACCOUNT
  add constraint ACCOUNT_PK primary key (ANAME)
  using index 
  tablespace ITHEIMA
  pctfree 10
  initrans 2
...
prompt
prompt Creating table COMPILER
prompt =======================
prompt
create table SSM.COMPILER
(
  c1 CLOB
)
tablespace ITHEIMA
