						...
						<c:forEach var="traveller" items="${orders.travellerList}">
							...
							<tr>
								...
								<td><input type="text" size="15"
									value="${traveller.credentialsType == 0?"身份证":traveller.credentialsType == 1? "护照":"军官证"}" readonly="readonly"></td>
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${orders.orderStatus==1}">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">在线支付-${orders.payType == 0?"支付宝":orders.payType == 1?"微信":"其他"}</div>
