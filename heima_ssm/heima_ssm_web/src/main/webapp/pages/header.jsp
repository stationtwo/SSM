...
<header class="main-header">
    <!-- Logo -->
    <a href="${pageContext.servletContext.contextPath}/index.jsp" class="logo">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="${pageContext.request.contextPath}/img/user3-128x128.jpg" class="img-circle"
                                 alt="User Image">

                            <p>
                                <sec:authentication property="name"/> - 草滩吴彦祖
                    ...
                    <div class="row">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="${pageContext.servletContext.contextPath}/logout.do" class="btn btn-default btn-flat">注销</a>
                            </div>
                        </li>
                    </ul>
                </li>
